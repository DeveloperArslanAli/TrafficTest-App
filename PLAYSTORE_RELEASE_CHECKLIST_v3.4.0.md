# Google Play Store Release & Publication Checklist — v3.4.0 🚀
...
| **Version Name** | `3.4.0` | ✅ Updated in `app.json`, `package.json`, and Gradle config |
| **Version Code** | `7` | ✅ Configured to `7` for Google Play Store upload |
...
## 📦 3. Production Publication Binaries

| Binary Type | File Path | Usage | Build Status |
| :--- | :--- | :--- | :--- |
| **Google Play App Bundle (.aab)** | `TrafficTest-v3.4.0-playstore-release.aab` | Upload to Play Console Production / Internal Track | ✅ **READY FOR UPLOAD** |
| **Universal Release APK (.apk)** | `TrafficTest-v3.4.0-universal-release.apk` | Direct Sideloading / QA Testing | ✅ **READY FOR TESTING** |
| **ARM64 Architecture APK** | `TrafficTest-v3.4.0-arm64-release.apk` | Optimized 64-bit Device Testing | ✅ **READY FOR TESTING** |
...
- [x] **Zero Hardcoded Question Counts**:
  ...
  * Removed all obsolete 820/320/80 fixed count references.
...
- [x] **Offline-First Storage Engine**:
  * 0ms synchronous read cache pre-seeded with clean authoritative question bank fallback.
...
5. Upload `TrafficTest-v3.4.0-playstore-release.aab`.
